        ...
        return (
            <Form onSubmit={this.handleSubmit}>
                <FormGroup>
                    ...
                    <br />
                    <Input id="brand" type="text" name="brand" value={this.state.brand} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                    <Label for="model">Model</Label>
                    <br />
                    <Input id="model" type="text" name="model" value={this.state.model} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                    ...
                    <br />
                    <Input id="frame" type="text" name="frame" value={this.state.frame} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                    ...
                    <br />
                    <Input id="fork" type="text" name="fork" value={this.state.fork} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                    <Label for="shock">Shock</Label>
                    <br />
                    <Input id="shock" type="text" name="shock" value={this.state.shock} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                    ...
                    <br />
                    <Input id="shifters" type="text" name="shifters" value={this.state.Shifters} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                    <Label for="derailleur">Derailleur</Label>
                    <br />
                    <Input id="derailleur" type="text" name="derailleur" value={this.state.derailleur} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                    <Label for="cassette">Cassette</Label>
                    <br />
                    <Input id="cassette" type="text" name="cassette" value={this.state.cassette} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                    <Label for="brakes">Brakes</Label>
                    <br />
                    <Input id="brakes" type="text" name="brakes" value={this.state.brakes} onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
                    <Label for="tires">Tires</Label>
                    <br />
                    <Input id="tires" type="text" name="tires" value={this.state.tires}  onChange={this.handleChange} />
                </FormGroup>
                <FormGroup>
